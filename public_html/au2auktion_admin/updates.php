...
'),
	...
	'),
		...
		"");
			...
			// Automatisk opdatering, genereret 03-10-2013 09:19:20
			$updates["2013100300"]["text"] = "Opdatering";
			$updates["2013100300"]["update"] = array(
						"FILE|Admin/pages/keep_alive.php",
						"FILE|Admin/pages/menu.php",
						"FILE|Admin/pages/settings.php",
						"FILE|html/admin_layout_frameset.html",
						"FILE|html/admin_layout_menu.html",
						"FILE|js/jquery/jquery-1.8.js",
			"");
			
			// Automatisk opdatering, genereret 03-10-2013 09:21:38
			$updates["2013100301"]["text"] = "Opdatering";
			$updates["2013100301"]["update"] = array(
						"FILE|Admin/pages/keep_alive.php",
						"FILE|class/form.php",
						"FILE|html/admin_layout_frameset.html",
			"");
			
			// Automatisk opdatering, genereret 07-10-2013 18:41:05
			$updates["2013100700"]["text"] = "Opdatering";
			$updates["2013100700"]["update"] = array(
						"FILE|class/email.php",
						"FILE|class/form.php",
						"FILE|html/admin_layout_menu.html",
			"");
			
			// Automatisk opdatering, genereret 25-10-2013 14:25:59
			$updates["2013102500"]["text"] = "Tilføjet printer funktion: print_file()";
			$updates["2013102500"]["update"] = array(
						"FILE|Admin/pages/settings.php",
						"FILE|class/email.php",
						"FILE|class/user.php",
						"FILE|inc/functions.php",
